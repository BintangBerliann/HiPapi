...
# Membuat widgets
login_label = tk.Label(frame, text="MENU LOGIN HI PAPI", bg='#E1E5F2', fg="#022B3A", font=("Ubuntu", 30))
text = tk.Label(frame, text="Silahkan login terlebih dahulu untuk menggunakan program ini.", bg='#E1E5F2', fg="#022B3A", font=("Ubuntu", 14))
username_label = tk.Label(frame, text="Username", bg='#022B3A', fg="#FFFFFF", font=("Ubuntu", 16),width=15)
username_entry = tk.Entry(frame, font=("Ubuntu", 16), width=30)
password_label = tk.Label(frame, text="Password", bg='#022B3A', fg="#FFFFFF", font=("Ubuntu", 16),width=15)
password_entry = tk.Entry(frame, show="*", font=("Ubuntu", 16),width=30)
login_button = tk.Button(frame, text="Login", bg="#022B3A", fg="#FFFFFF", font=("Ubuntu", 16), command=login)

# Menampilan widgets ke layar
login_label.grid(row=0, column=0,columnspan=2,pady=(250,10))
text.grid(row=1,column=0,columnspan=2,pady=(0,50))
