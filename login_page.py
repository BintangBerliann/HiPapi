...
login_label = tk.Label(
    frame, text="Login HI PAPI", bg='#E1E5F2', fg="#022B3A", font=("Ubuntu", 30))
username_label = tk.Label(
    frame, text="Username", bg='#022B3A', fg="#FFFFFF", font=("Ubuntu", 16))
username_entry = tk.Entry(frame, font=("Ubuntu", 16))
password_entry = tk.Entry(frame, show="*", font=("Ubuntu", 16))
password_label = tk.Label(
    frame, text="Password", bg='#022B3A', fg="#FFFFFF", font=("Ubuntu", 16))
